...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    if temperature*neutrons_produced_per_second < threshold*0.9:
        return 'LOW'
    if temperature*neutrons_produced_per_second <= threshold*1.1 and temperature*neutrons_produced_per_second >= threshold:
        return 'NORMAL'
    if temperature*neutrons_produced_per_second <= threshold and temperature*neutrons_produced_per_second >= threshold*0.9:
        return 'NORMAL'
    else:
        return 'DANGER'
